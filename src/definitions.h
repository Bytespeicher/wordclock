...
int EINS[] = {46, 47, 48, 49};
int EIN[] = {46, 47, 48};
int ZWEI[] = {44, 45, 46, 47};
int DREI[] = {39, 40, 41, 42};
int VIER[] = {29, 30, 31, 32};
int FUENF[] = {33, 34, 35, 36};
int SECHS[] = {1, 2, 3, 4, 5};
int SIEBEN[] = {49, 50, 51, 52, 53, 54};
int ACHT[] = {17, 18, 19, 20};
int NEUN[] = {25, 26, 27, 28};
int ZEHN[] = {13, 14, 15, 16};
int ELF[] = {22, 23, 24};
int ZWOELF[] = { 56, 57, 58, 59, 60};
